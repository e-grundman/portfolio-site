...
summary: "A retailer's delivery window came with fees attached, and the routing logic was planning to an average. Percentiles fixed the math. One question moved the constraint the math was working inside."
