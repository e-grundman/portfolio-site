...
<Figure
  ...
  caption="carrier-scheduling, active dwell. Every gaylord on the dock, with how long it has been sitting, how many packages are inside, and how many of them have stopped scanning. Rows past the escalation age open a ticket on their own. Warehouse names, carrier names, barcodes, and sort codes are replaced, and the exposed cart value is illustrative. Counts, ages, and percentages are as captured."
  height={879}
/>
